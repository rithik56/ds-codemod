...
const PACKAGE_REGEXP = /@am92\/x-date-pickers(-pro|)(\/(.*)|)/;
...
export default function transformer(file: JsCodeShiftFileInfo, api: JsCodeShiftAPI, options: any) {
  ...
  // - import { DayCalendarSlotsComponent } from '@am92/react-design-system'
  // + import { DayCalendarSlots } from '@am92/react-design-system'
  matchingImports
